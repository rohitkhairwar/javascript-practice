...
Write a function that takes an array of arrays and
 returns the value of all of the symbols in it, where
...
!! = -3
!!! = -5
An array of arrays containing 2 #s, a O, and a !!! 
would equal (0 + 5 + 5 + 3 - 5) 8.

If the final score is negative, return 0 
(e.g. 3 #s, 3 !!s, 2 !!!s and a X would be
...
const checkScore = (arr)  => {
    let sum = 0;
    let scoreArr = arr.flat();
    for (let i = 0; i < scoreArr.length; i++) {
        let element = scoreArr[i];
        switch(element) {
            case "#": sum+= 5;
            break;
            case "O" : sum += 3;
